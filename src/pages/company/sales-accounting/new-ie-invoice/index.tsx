      ...
      <Form layout="vertical" onFinish={onFinish}>
        <Card title="اطلاعات اولیه کسب و کار" className='mb-4'>
          <div className='flex gap-6'>
            <Form.Item label="نام کسب و کار" name="nationalID" className='flex-1'>
              <Input />
            </Form.Item>
            <Form.Item label="شماره صورتحساب" name="" className='flex-1'>
              <Input />
            </Form.Item>
            <Form.Item label="تاریخ صدور" name="" className='flex-1'>
              <Input />
            </Form.Item>
            <div>
              <span>ثبت اطلاعات حسابداری (اختیاری)</span>
            </div>
            <Form.Item label="مرجع حسابداری" name="nationalID" className='flex-1'>
              <Input />
            </Form.Item>
            <Form.Item label="شماره فاکتور" name="" className='flex-1'>
              <Input />
            </Form.Item>
            <Form.Item label="تاریخ فاکتور" name="" className='flex-1'>
              <Input />
            </Form.Item>
          </div>
          <div className='flex gap-6'>
